...
const Hero = () => {
  ...
  const getDownloadButtonClasses = () => {
    const baseClasses = "px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 horizontal-full font-semibold text-sm sm:text-base flex items-center justify-center gap-2 sm:gap-3 w-full sm:w-auto min-w-[140px] sm:min-w-[160px] md:min-w-[180px] transition-all duration-500 transform"
  ...
  return (
    <section id="home" className="min-h-screen flex items-end sm:items-center justify-center relative overflow-hidden hero-custom-bg pb-16 sm:pb-20 md:pb-24">
      ...
      <div className="lg:hidden absolute top-4 sm:top-6 left-1/2 transform -translate-x-1/2 z-20 animate-fade-in">
        <div className="mobile-status-card bg-white/90 backdrop-blur-sm px-3 sm:px-4 py-2 sm:py-3 horizontal-full shadow-md">
          <div className="flex items-center justify-center gap-2 mb-0.5 sm:mb-1 transition-all duration-300 hover:scale-105">
            ...
            <span className="text-[10px] sm:text-xs font-medium text-charcoal">Available for work</span>
          </div>
          <p className="text-[9px] sm:text-xs text-medium-gray text-center transition-all duration-300">Open to new opportunities</p>
        </div>
      </div>
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between min-h-[80vh] sm:min-h-[85vh] py-8 sm:py-12 md:py-16">
          ...
          <div className="w-full lg:flex-1 space-y-4 sm:space-y-5 md:space-y-6 animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 md:gap-4 w-full">
              <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
                ...
                <div className="flex items-center gap-1.5 sm:gap-2 text-medium-gray">
                  <FaMapMarkerAlt className="text-[#00786f] flex-shrink-0" size={12} />
                  <span className="text-xs sm:text-sm font-medium whitespace-normal sm:whitespace-nowrap">Mumbai, Maharashtra, India</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col xs:flex-row gap-3 w-full animate-fade-in-up" style={{animationDelay: '0.2s'}}>
              <button
              ...
              >
                Get In Touch
                <FaArrowRight className="group-hover:translate-x-1 transition-transform duration-300 flex-shrink-0" size={14} />
              </button>
            ...
            {/* Social Integration */}
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 md:gap-4 w-full animate-fade-in-up" style={{animationDelay: '0.3s'}}>
              <span className="text-medium-gray text-xs sm:text-sm font-medium">Follow:</span>
              <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
                <a 
          ...
          <div className="hidden lg:flex flex-col justify-center items-center ml-6 xl:ml-8 mt-6 lg:mt-0 relative h-full animate-fade-in-up" style={{animationDelay: '0.5s'}}>
            <div className="text-center">
              ...
              <div className="simple-status-card bg-white/90 backdrop-blur-sm px-6 py-4 horizontal-2xl shadow-md border border-light-gray/30">
                <div className="flex items-center justify-center gap-2 mb-2">
                  ...
                  <span className="text-xs sm:text-sm font-medium text-charcoal">Available for work</span>
                </div>
                <p className="text-[10px] sm:text-xs text-medium-gray">Open to new opportunities</p>
              </div>
